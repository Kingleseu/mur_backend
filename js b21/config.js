...
const CATEGORY_KEYWORDS = {
  "Guérison": [
    // Racines santé / maladie
    "guer",       // guerison, guerir, gueri, guerie
    "malad",      // maladie, malade
    "sant",       // sante, santé
    "douleur",
    "blessur",
    "paralys",
  ...
  "Provision": [
    ...
    "voiture",
    "vehicul",
    // Études payées (souvent provision aussi)
    "frais scol",
    "frais acad",
    "frais univers",
    "inscription paye",
  ...
  "Délivrance": [
    // Racines délivrance / libération
    "delivr",
    "liberat",
    "emancip",
    "brise les chaines",
    // Liens / jougs / blocages
    "chaine",
    "chaines",
    "lien",
    "liens",
